      ...
      <div className="flex h-full flex-col items-center md:flex-row md:items-end">
        ...
        <div className="relative h-48 w-56 md:h-full md:w-72">
          <div className="absolute -top-24 bottom-0 left-0 right-0 overflow-hidden rounded-xl shadow-2xl ring-1 ring-black/5 md:-bottom-6 md:-top-6 md:left-6">
            <img className="absolute inset-0 h-full w-full object-cover transition duration-300 group-hover:-rotate-1 group-hover:scale-105" src="https://images.unsplash.com/photo-1597019558926-3eef445fdf60?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8ODF8fHNrYXRlYm9hcmRlciUyMHN1bnNldHxlbnwwfHwwfHx8MA%3D%3D" />
          </div>
        </div>
        {/* Content */}
        <div className="mt-4 flex flex-1 flex-col justify-end self-stretch p-6 text-center md:mt-0 md:text-left">
          ...
          <a href="#" className="mt-4 flex items-center justify-center gap-2 rounded-md bg-cyan-100 p-4 text-cyan-950 hover:bg-cyan-200">
            <span>View all</span>
