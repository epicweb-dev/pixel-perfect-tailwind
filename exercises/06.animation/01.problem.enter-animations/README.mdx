...
🐨 Animate the logo, `h1` and paragraph using the new `slide-up` animation utilies you have just created.
...
👨‍💼 You got this! Rememeber, you'll be considered a hero to the eyes of the design team if you can pull this off 💫
