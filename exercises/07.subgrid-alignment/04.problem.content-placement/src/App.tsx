...
export default function App() {
	return (
		<div className="grid min-h-screen place-items-center">
			...
			*/}
			<div className="grid place-items-center gap-12 px-4 py-16 sm:gap-16 xl:grid-cols-[auto,1fr] xl:gap-x-24 xl:gap-y-4">
				{/* 
					🐨 
						1. Coordinate the horizontal `gap` (level 4) on the subgrid
						2. Make sure the first column (logo) only use the space it needs

						💰 You can use `grid-cols-[auto,1fr]` to achieve task #2
				*/}
				<div
					className={clsx(
